...
// added namespace just in case you have this script modified somewhere
namespace unitycodercom_pointcloud_extras
{
	...
	public class SimpleSmoothMouseLook : MonoBehaviour
	{
		...
		public bool rotateWithRightMouse = false;
	    ...
	    void Update()
	    {
			...
			if (rotateWithRightMouse && !Input.GetMouseButton(1)) return;
