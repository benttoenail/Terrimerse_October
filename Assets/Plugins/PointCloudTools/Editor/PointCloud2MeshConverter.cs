...
namespace unitycodercom_PointCloud2MeshConverter
{
	...
	public class PointCloud2MeshConverter : EditorWindow
	{
		...
		private Object sourceFileArray; // ADDED
...
//			EditorGUILayout.Space();
			...
			//SOURCEFILE ARRAY ADDED
			GUILayout.Label("point clouds file array", EditorStyles.boldLabel);
			sourceFileArray = EditorGUILayout.ObjectField(sourceFileArray, typeof(Object), false);
